...
| Project | Description |
|---------|-------------|
| **Taskify — Task Management App** | A cross-platform task organizer built with Flutter & Firebase featuring real-time sync and smart sorting. |
| **ShopEase** | Flutter e-commerce UI with intuitive navigation and performance optimizations. |
| **Auto-Job-Apply-AI** | Python script for automated job applications with customization and logging. |
